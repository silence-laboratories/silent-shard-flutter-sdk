...
enum tss_error p1_keyshare_key_id(struct Handle share, struct tss_buffer *buf);
...
enum tss_error p2_keyshare_key_id(struct Handle share, struct tss_buffer *buf);
