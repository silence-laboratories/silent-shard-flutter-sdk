...
#define __GMP_CFLAGS " --target=arm64-apple-darwin -arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.3.sdk -Wno-error -Wno-implicit-function-declaration"
